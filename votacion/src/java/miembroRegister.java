...
import voto.UserDAO;
import voto.UserDTO;
import voto.miembro_mesa;
import voto.miembro_mesaDAO;
...
public class miembroRegister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            miembro.setId_persona(request.getParameter("id_persona"));
            miembro.setId_mesa(request.getParameter("id_mesa"));
            
            
            
            
            miembro_mesaDAO miembro1=new miembro_mesaDAO();
            
            
            
            if(miembro1.Signup(miembro)){
